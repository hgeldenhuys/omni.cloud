...
CREATE TABLE user_credentials (
  ...
  CONSTRAINT "idx_user_credentials_userId" UNIQUE ( "userId" )
);
CREATE INDEX idx_user_credentials ON user_credentials ( auth_provider );
ALTER TABLE user_credentials ADD CONSTRAINT fk_user_credentials_users FOREIGN KEY ( "userId" ) REFERENCES users( id );

ALTER TABLE user_credentials ADD "password" varchar(60);
insert into user_credentials ("userId", auth_provider, "password") select id, 'internal', password from users;
